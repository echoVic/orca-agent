...
const copy = {
  ...
  zh: {
    ...
    summaries: {
      "v0.4.31":
        "将直接、嵌套、Workflow、托管与恢复后的子代理统一到一个持久执行作用域，提供排队准入、持久预算回执、可恢复结果投递和共享任务控制面；bash 长命令也纳入同一任务生命周期，并保留网络权限重试与准确的取消、超时和退出终态。",
      "v0.4.30":
