...
export const releaseVersion = "v0.4.19";

export const releases = [
  {
    version: "v0.4.19",
    date: "2026-09-06",
    title: "Focused release gates",
    body: "Runs the release gate against the exact Goal recovery regressions and contract suites while retaining complete workspace compilation.",
    url: "https://github.com/echoVic/orca-agent/releases/tag/v0.4.19",
  },
  {
    version: "v0.4.18",
    date: "2026-09-06",
  ...
  },
  {
    version: "v0.4.13",
    date: "2026-09-05",
    title: "Fenced async child routing",
    body: "Finalizes live child conversation delivery by routing fenced TUI async agents through durable task ownership while preserving legacy hosted agents, root session identity, and isolated release validation.",
    url: "https://github.com/echoVic/orca-agent/releases/tag/v0.4.13",
  },
  {
    version: "v0.4.12",
    date: "2026-09-05",
