...
const CURRENT_ACTIONS: [(&str, &str); 49] = [
    ...
    ("FocusChildThread", "thread_attachment_mutation"),
    ("ReturnToParentThread", "thread_attachment_mutation"),
    ...
    ("ResumeTask", "task_mutation"),
    ("RetryTask", "task_mutation"),
    ("FollowUpTask", "task_mutation"),
...
fn current_user_action_name(action: &UserAction) -> &'static str {
    match action {
        ...
        UserAction::FocusChildThread { .. } => "FocusChildThread",
        UserAction::ReturnToParentThread => "ReturnToParentThread",
        ...
        UserAction::ResumeTask { .. } => "ResumeTask",
        UserAction::RetryTask { .. } => "RetryTask",
        UserAction::FollowUpTask { .. } => "FollowUpTask",
