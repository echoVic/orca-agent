...
pub mod child_budget_ledger;
mod child_permission;
pub mod command;
pub mod compaction;
pub use compaction::{
...
pub mod surface {
    pub use crate::runtime_surface::{
        ...
        RuntimeSettingsTarget, RuntimeSubagentActivityIngress, RuntimeSurfaceClientHandle,
        RuntimeSurfaceHandle, RuntimeSurfaceHostHandle, RuntimeSurfaceMutationResult,
        RuntimeSurfaceThreadHandle, RuntimeWorkflowAgentProgress, RuntimeWorkflowFinished,
        RuntimeWorkflowIngressReceipt, RuntimeWorkflowLifecycleIngress, RuntimeWorkflowOutcome,
        RuntimeWorkflowProgress, RuntimeWorkflowProgressIngress, RuntimeWorkflowStarted,
        SAFE_DIAGNOSTIC_TEXT_BYTE_LIMIT, SURFACE_COMMIT_BATCH_BYTE_LIMIT,
        SURFACE_COMMIT_BATCH_EVENT_LIMIT, SURFACE_COMPLETION_PROOF_LIMITATION_LIMIT,
        ...
        SURFACE_SUBSCRIBER_BYTE_LIMIT, SURFACE_SUBSCRIBER_EVENT_LIMIT,
        SURFACE_VERIFICATION_OUTPUT_BYTE_LIMIT, SafeDiagnosticText, SecretReference,
        SequenceNumber, SessionCatalogCursor, SessionCatalogRevision, SessionHealthRevision,
        SessionListArchiveFilter, SessionListFilter, SessionMetadataMutationOutput,
        SessionMetadataPatch, SessionMetadataPrecondition, SessionMetadataRevision,
        SessionPageRequest, SessionPatch, SessionReadToken, SessionRelationFilter,
        SessionSearchArchiveFilter, SessionSearchRequest, SessionSetFilter, SessionSortKey, Set,
        SettingsMutationOutput, SettingsPatch, SettingsRevision, SettlementError, Sha256Digest,
        ...
        ShutdownPlanError, ShutdownRequestCause, ShutdownScope, ShutdownSelectedCause,
        ShutdownThreadPlan, ShutdownThreadRequirement, SnapshotAtCursor, SnapshotRequired,
        SnapshotRequiredReason, SortDirection, StaleLiveCapsuleDescriptor, StaleMutationError,
        StartCommitDegradedState, SteerOutput, StoreProviderCredential,
        StoreProviderCredentialError, StoreProviderCredentialResult, SubagentPatch,
        SubagentRevision, SurfaceActivePermissionProfile, SurfaceActivityId,
        SurfaceAdditionalWorkingDirectory, SurfaceAdmissionLeaseId, SurfaceAgentLoopTurn,
        SurfaceAllowDeny, SurfaceApprovalMode, SurfaceAssistantMessageItem,
        ...
        SurfaceCommitLedger, SurfaceCompletedModelResponse, SurfaceCompletionVerification,
        SurfaceConnectionId, SurfaceContextFragment, SurfaceContextFragmentKind,
        SurfaceContextFragmentOrigin, SurfaceContextSnapshot, SurfaceCursor, SurfaceDataProperty,
        SurfaceDataValue, SurfaceEvent, SurfaceEventEnvelope, SurfaceEventId, SurfaceEvidenceItem,
        SurfaceEvidenceKind, SurfaceFactFamily, SurfaceFileChange,
        SurfaceFileSystemPermissionProfile, SurfaceFinalizeIntentId, SurfaceFolderTrustReceipt,
        SurfaceGenerationId, SurfaceGoal, SurfaceGoalCloseReason, SurfaceGoalClosedRunReceipt,
        SurfaceGoalFence, SurfaceGoalGap, SurfaceGoalGenerationIdentity, SurfaceGoalId,
        SurfaceGoalIntent, SurfaceGoalIntentAck, SurfaceGoalIntentId, SurfaceGoalNoLiveRun,
        SurfaceGoalOuterTurnId, SurfaceGoalOuterTurnReceipt, SurfaceGoalOuterTurnReceiptOrigin,
        SurfaceGoalPauseReason, SurfaceGoalReceiptState, SurfaceGoalRun, SurfaceGoalRunId,
        SurfaceGoalRunOrigin, SurfaceGoalRunPhase, SurfaceGoalRunReceipt, SurfaceGoalState,
        SurfaceGoalStoreReceipt, SurfaceGoalTransition, SurfaceGoalVerification,
        SurfaceHealthClearProof, SurfaceHealthIssue, SurfaceHealthIssueId,
        SurfaceHistoryAssistantRole, SurfaceHistoryFileChange, SurfaceHistoryId,
        SurfaceHistoryItem, SurfaceHistoryItemEntry, SurfaceHistoryMessage, SurfaceHistoryRole,
        SurfaceHistoryRunningStatus, SurfaceHistoryStatus, SurfaceHistorySystemRole,
        SurfaceHistoryTerminalStatus, SurfaceHistoryToolKind, SurfaceHistoryToolRole,
        SurfaceHistoryTurn, SurfaceHistoryUserRole, SurfaceHostBoundCaller, SurfaceHostCommand,
        SurfaceHostShutdownReceipt, SurfaceHostShutdownStage, SurfaceHub, SurfaceHubBindError,
        SurfaceHubConfig, SurfaceHubCreateError, SurfaceImageDetail, SurfaceImageSource,
        SurfaceIncarnation, SurfaceInput, SurfaceInputBinding, SurfaceInputBindingKind,
        SurfaceInputBindingRequest, SurfaceInputBlock, SurfaceInputCatalogEntry,
        SurfaceInputCatalogPage, SurfaceInputCorrelationId, SurfaceInputPresentation,
        ...
        SurfacePermissionContext, SurfacePermissionDecision, SurfacePermissionDomainPattern,
        SurfacePermissionNetworkProfile, SurfacePermissionOrigin, SurfacePermissionOwnerRef,
        SurfacePermissionPathLabel, SurfacePermissionProfile, SurfacePermissionRule,
        SurfacePermissionRuleSelector, SurfacePermissionRuleSet, SurfacePermissionUpdate,
        ...
        SurfaceProjectionContext, SurfacePublisherPermit, SurfacePublisherPermitId,
        SurfaceRawToolCall, SurfaceReadError, SurfaceReadErrorClass, SurfaceReadErrorCode,
        SurfaceReadResult, SurfaceReadRevision, SurfaceReasoningEffort,
        ...
        SurfaceResponseReceiptId, SurfaceResponseToken, SurfaceResumeBoundary,
        SurfaceRuntimeSettings, SurfaceRuntimeSettingsReceipt, SurfaceSchema, SurfaceSchemaInteger,
        SurfaceSchemaProperty, SurfaceScope, SurfaceSessionCatalogAction,
        SurfaceSessionCatalogReceipt, SurfaceSessionHealth, SurfaceSessionMetadata,
        SurfaceSessionMetadataReceipt, SurfaceSessionPageCursor, SurfaceSessionReadBundle,
        SurfaceSessionSearchHit, SurfaceSessionSearchPage, SurfaceSessionSummary,
        SurfaceSessionSummaryPage, SurfaceSettingsDestination, SurfaceSettingsSnapshot,
        SurfaceSettlementId, SurfaceSettlementReceipt, SurfaceShutdownReason, SurfaceSnapshot,
        SurfaceStreamId, SurfaceSubagent, SurfaceSubagentContinuation, SurfaceSubagentId,
        SurfaceSubagentOwner, SurfaceSubagentPhase, SurfaceSubagentSource, SurfaceSubagentStatus,
        SurfaceSubagentTerminalStatus, SurfaceSubscriptionHandle, SurfaceSubscriptionItem,
        SurfaceSubscriptionReceiver, SurfaceSubscriptionSealReason, SurfaceTask,
        SurfaceTaskAttemptId, SurfaceTaskFence, SurfaceTaskId, SurfaceTaskOwnerRef,
        SurfaceTaskRunningStatus, SurfaceTaskStatus, SurfaceTaskType, SurfaceTerminalExitStatus,
        SurfaceThreadCreateSpec, SurfaceThreadId, SurfaceThreadPage, SurfaceThreadPageCursor,
        SurfaceThreadSnapshot, SurfaceToolAction, SurfaceToolCallId, SurfaceToolCompletionReceipt,
