...
pub mod surface {
    pub use crate::runtime_surface::{
        ...
        SurfaceResponseReceiptId, SurfaceResponseToken, SurfaceResumeBoundary, SurfaceRuntimeSettings,
        ...
        SurfaceSubagent, SurfaceSubagentId, SurfaceSubagentPhase, SurfaceSubagentStatus,
        SurfaceSubagentTerminalStatus, SurfaceSubscriptionHandle, SurfaceSubscriptionItem,
        SurfaceSubscriptionReceiver, SurfaceSubscriptionSealReason, SurfaceTask, SurfaceTaskFence,
        SurfaceTaskId, SurfaceTaskRunningStatus, SurfaceTaskStatus, SurfaceTaskType,
        SurfaceTerminalExitStatus, SurfaceThreadCreateSpec, SurfaceThreadId, SurfaceThreadPage,
        SurfaceThreadPageCursor, SurfaceThreadSnapshot, SurfaceToolAction, SurfaceToolCallId,
        SurfaceToolCompletionReceipt, SurfaceToolRequest, SurfaceToolResult,
        SurfaceToolResultKind, SurfaceToolTerminal, SurfaceToolTerminalStatus, SurfaceToolView,
        SurfaceToolViewState, SurfaceTurnId,
