...
pub mod surface {
    pub use crate::runtime_surface::{
        ...
        SURFACE_COMPLETION_PROOF_LIMITATION_LIMIT, SURFACE_COMPLETION_PROOF_TEXT_BYTE_LIMIT,
        SURFACE_COMPLETION_PROOF_TOOL_RECEIPT_LIMIT, SURFACE_RESERVATION_LEASE_MS,
        SURFACE_RETAINED_BYTE_LIMIT, SURFACE_RETAINED_EVENT_LIMIT, SURFACE_SUBSCRIBER_BYTE_LIMIT,
        SURFACE_SUBSCRIBER_EVENT_LIMIT, SURFACE_VERIFICATION_OUTPUT_BYTE_LIMIT, SafeDiagnosticText,
        ...
        SurfaceAdmissionLeaseId, SurfaceAgentLoopTurn, SurfaceAllowDeny, SurfaceApprovalMode,
        SurfaceAssistantMessageItem, SurfaceAssistantPlanItem, SurfaceAssistantReasoningItem,
        SurfaceAssistantStream, SurfaceAssistantStreamState, SurfaceAttachAuthority,
        SurfaceAttachmentCapabilities, SurfaceAttachmentGrant, SurfaceAttachmentId,
        SurfaceAttachmentRole, SurfaceBackgroundFence, SurfaceBackgroundOperation,
        SurfaceBackgroundOwnerToken, SurfaceBatchReceipt, SurfaceBlocker, SurfaceBlockerKind,
        SurfaceBoundCaller, SurfaceCapability, SurfaceCapabilityCall, SurfaceCapabilityCallId,
        SurfaceCapabilityCallKind, SurfaceCapabilityCallState, SurfaceCatalogEntry,
        SurfaceCatalogEntryId, SurfaceClientCommandError, SurfaceClientInteractionAnswer,
        SurfaceCommand, SurfaceCommitApplied, SurfaceCommitBatch,
        SurfaceCommitBatchPreflightErrorCode, SurfaceCommitBatchPreflightResult,
        SurfaceCommitError, SurfaceCommitId, SurfaceCommitLedger, SurfaceCompletedModelResponse,
        SurfaceCompletionVerification, SurfaceConnectionId, SurfaceContextFragment,
        SurfaceContextFragmentKind, SurfaceContextFragmentOrigin, SurfaceContextSnapshot,
        SurfaceCursor, SurfaceDataProperty, SurfaceDataValue, SurfaceEvent, SurfaceEventEnvelope,
        SurfaceEventId, SurfaceEvidenceItem, SurfaceEvidenceKind, SurfaceFactFamily,
        SurfaceFileChange, SurfaceFileSystemPermissionProfile, SurfaceFinalizeIntentId,
        SurfaceFolderTrustReceipt, SurfaceGenerationId, SurfaceGoal, SurfaceGoalCloseReason,
        SurfaceGoalClosedRunReceipt, SurfaceGoalFence, SurfaceGoalGap,
        ...
        SurfaceStreamId, SurfaceSubagent, SurfaceSubagentId, SurfaceSubagentPhase,
        ...
        SurfaceToolCallId, SurfaceToolCompletionReceipt, SurfaceToolRequest, SurfaceToolResult,
        SurfaceToolResultKind, SurfaceToolTerminal, SurfaceToolTerminalStatus, SurfaceToolView,
        SurfaceToolViewState, SurfaceTurnId, SurfaceUnavailableReason, SurfaceUsageSnapshot,
        SurfaceUserInputDecision, SurfaceUserInputState, SurfaceValueError,
        SurfaceVerificationResult, SurfaceWorkflow, SurfaceWorkflowAgent,
        ...
        TaskControlAction, TaskControlOutput, TaskPatch, TaskRevision,
        TerminalProjectionDeferredState, TerminalizationCause, ThreadCursorAckRequirement,
        ThreadItemTurnFilter, ThreadOwnerEpoch, ThreadOwnershipLease, ThreadPageCursor,
        ThreadPageQuery, ThreadPersistence, ThreadSettingsReceipt, ToolInvocationRevision,
        ToolInvocationStarted, ToolInvocationStartedReceiptV1, ToolPatch, ToolTerminalSource,
        TransferBackgroundOutput, TrustRevision, TurnItemsView, TurnRequestBudgetScope,
        UnavailableMutationError, UncommittedMutation, Unit, UnixMillis, UsageRevision,
        UsageTotals, Uuid, UuidV7, ValidatedInteractionResponse, WaitOperationTerminalRequest,
        WaitOperationTerminalResult, WorkflowCatalogRevision, WorkflowControlAction,
        WorkflowControlOutput, WorkflowPatch, WorkflowRevision, ZeroizingProcessLocalSecret,
        canonical_batch_digest, canonical_batch_encoded_bytes, canonical_event_digest,
        canonical_replayability_digest, decide_post_materialization_recovery, preflight_batch,
        reconcile_finalize_intent, reduce_batch, select_shutdown_cause,
    };
}
