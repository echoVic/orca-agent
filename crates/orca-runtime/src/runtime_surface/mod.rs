...
pub use projection::{
    ...
    SurfaceSettingsSnapshot, SurfaceSubagent, SurfaceSubagentOwner, SurfaceSubagentPhase,
    SurfaceSubagentSource, SurfaceSubagentStatus, SurfaceSubagentTerminalStatus, SurfaceTask,
    SurfaceTaskStatus, SurfaceTaskType, SurfaceTerminalExitStatus, SurfaceThreadSnapshot,
    SurfaceToolCompletionReceipt, SurfaceToolResult, SurfaceToolResultKind, SurfaceToolTerminal,
    SurfaceToolTerminalStatus, SurfaceToolView, SurfaceToolViewState, SurfaceUsageSnapshot,
