...
pub use identity::{
    ...
    Sha256Digest, SubagentRevision, SurfaceAdmissionLeaseId, SurfaceAttachmentGrant,
    SurfaceAttachmentId, SurfaceAttachmentRole, SurfaceBackgroundFence,
...
pub use projection::{
    ...
    SurfaceThreadSnapshot, SurfaceToolResult, SurfaceToolResultKind, SurfaceToolTerminal,
