...
pub use identity::{
    ...
    SurfaceStreamId, SurfaceSubagentId, SurfaceTaskAttemptId, SurfaceTaskFence, SurfaceTaskId,
    SurfaceTaskOwnerRef, SurfaceThreadId, SurfaceToolCallId, SurfaceTurnId,
...
pub use ingress::{
    ...
    RuntimeWorkflowAgentProgress, RuntimeWorkflowIngressReceipt, RuntimeWorkflowLifecycleIngress,
...
pub use projection::{
    ...
    SurfaceContextSnapshot, SurfaceEvidenceItem, SurfaceEvidenceKind, SurfaceFactFamily,
    SurfaceFileChange, SurfaceGoal, SurfaceGoalCloseReason, SurfaceGoalClosedRunReceipt,
    SurfaceGoalGap, SurfaceGoalIntent, SurfaceGoalIntentAck, SurfaceGoalNoLiveRun,
    ...
    SurfaceGoalRunReceipt, SurfaceGoalState, SurfaceGoalStoreReceipt, SurfaceGoalTransition,
    ...
    SurfaceOperationCompletionProof, SurfacePinnedContextEntry, SurfacePinnedContextKind,
    SurfacePinnedContextSnapshot, SurfacePlanItem, SurfacePlanPriority, SurfacePlanSnapshot,
    SurfacePlanStatus, SurfaceRawToolCall, SurfaceRemoteTerminalLease,
    SurfaceRemoteTerminalLeaseState, SurfaceResumeBoundary, SurfaceSessionHealth,
    SurfaceSettingsSnapshot, SurfaceSubagent, SurfaceSubagentContinuation, SurfaceSubagentOwner,
    ...
    SurfaceTerminalExitStatus, SurfaceThreadSnapshot, SurfaceToolCompletionReceipt,
    SurfaceToolResult, SurfaceToolResultKind, SurfaceToolTerminal, SurfaceToolTerminalStatus,
    SurfaceToolView, SurfaceToolViewState, SurfaceUsageSnapshot, SurfaceUserInputState,
    SurfaceVerificationResult, SurfaceWorkflow, SurfaceWorkflowAgent, SurfaceWorkflowAgentStatus,
    SurfaceWorkflowPhase, SurfaceWorkflowResult, SurfaceWorkflowResultStatus,
    SurfaceWorkflowStatus, TaskPatch, ThreadPersistence, ToolInvocationStarted,
    ToolInvocationStartedReceiptV1, ToolPatch, ToolTerminalSource, WorkflowPatch,
};
