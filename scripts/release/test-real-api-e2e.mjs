...
`,
  ...
  for (const expected of [
    ...
    `server-stdin {"id":"server-thread-list-metadata-filter","method":"thread/list","params":{"searchTerm":"${serverThreadSentinel}","cwd":"/tmp/fake","modelProviders":["deepseek"],"model":"deepseek-flash","sortKey":"updatedAt","limit":10}}`,
    `server-stdin {"id":"server-thread-list-metadata-filter-miss","method":"thread/list","params":{"searchTerm":"${serverThreadSentinel}","cwd":"/tmp/fake/missing","modelProviders":["deepseek"],"model":"deepseek-flash","sortKey":"updatedAt","limit":10}}`,
